...
a = Analysis(
    ['runui.py'],  # Thay thế bằng đường dẫn đến file chính của bạn
...
exe = EXE(
    ...
    name='SocialDownload',  # Đặt tên cho file .exe của bạn
    debug=True,  # Nếu cần debug, chuyển thành True
...
coll = COLLECT(
    ...
    strip=False,
    upx=True,
    name='SocialDownload',  # Đặt tên cho thư mục chứa file .exe
)
